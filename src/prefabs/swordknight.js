class Swordknight extends Phaser.Physics.Arcade.Sprite {
    ...
    update() {
        // swordfish selected
        if (game.settings.playerSelection == 2 && game.settings.p2ActionAvailable == true) {
            // player motion ↑↓←→
            if (Phaser.Input.Keyboard.JustDown(keyUP)) {
                ...
                game.settings.p2ActionAvailable = false;
